...
Uso:
    ...
    python3 compare_wiener_vs_optimum_m205.py --csv-a m205_results_wiener/BI_results_m205_wiener.csv --csv-b m205_results_wiener_freq/BI_results_m205_wiener_freq.csv --label-a "Wiener lambda" --label-b "Wiener lambda(f)" --tag WF_vs_WFfreq
