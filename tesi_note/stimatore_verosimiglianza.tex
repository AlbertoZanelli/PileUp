...
Alla fine di ogni passaggio c'è la parte di codice che lo realizza (riquadri grigi), copiata dai
file del progetto e spiegata riga per riga. Lo stimatore sta tutto nella classe
\texttt{PileupLikelihood} di \texttt{src/pileup\_likelihood.py}: il costruttore
\texttt{\_\_init\_\_} calcola una volta per canale e punto di lavoro tutto ciò che non dipende
dall'evento, il metodo \texttt{statistic} calcola $M$ per ogni evento. Gli estratti sono in ordine
di derivazione, non di file; i commenti del codice originale sono stati accorciati.
...
\label{sec:risultati}
%==========================================================================================
Riferimento: il rapporto dei massimi $Y$ con i filtri Wiener addestrati a 500 passi (campagna
\texttt{\_swna1}).
